...
const TeacherSidebar: React.FC = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: <MdDashboard size={22} />, path: '/teacher/dashboard' },
    { name: 'Profile', icon: <MdEventAvailable size={22} />, path: '/teacher/profile' },
    { name: 'Attendance', icon: <MdEventAvailable size={22} />, path: '/teacher/Attendance' },
    { name: 'Chat', icon: <MdChat size={22} />, path: '/teacher/chat' },
    { name: 'Notes', icon: <FaRegNoteSticky size={22} />, path: '/teacher/notes' },
    { name: 'Leave Management', icon: <FaRegCalendarAlt size={22} />, path: '/teacher/leave/teacher' },
    { name: 'LiveSessions', icon: <RiLiveFill size={22} />, path: '/teacher/live-session' },
  ];
